...
public class Application {
	...
	private static void runGame(boolean challengeMode, int targetMoves, int targetEcoPoints){
		...
		park1.at(34, 3).addActor(new Pterodactyl("Pterodactyl A (M)", Sex.Male, 60,AgeGroup.ADULT, 30));
		park1.at(35, 3).addActor(new Pterodactyl("Pterodactyl B (F)", Sex.Female, 60, AgeGroup.ADULT, 30));
